...
public class IndiaStatsWidgetConfigureActivity extends Activity {
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = IndiaStatsWidgetConfigureActivity.this;
            ...
            IndiaStatsWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId);
    ...
    public IndiaStatsWidgetConfigureActivity() {
        super();
    }
